...
As músicas de ambas as bandas sempre me pareceram energéticas e animadas, isso é verdade?
...
As músicas de ambas as bandas se concentram acima dos quadrantes 3 e 4 (acima de 0.5 em energia), o que diz que sim, elas são energéticas e o fato de haver uma concentração maior do lado direito indica que elas são mais alegres que tristes. No caso do Arctic Monkeys é mais fácil observar isso pois a maior parte das músicas estão concentradas acima de 0.75 para energia e 0.5 para valência. Já o The Last Shadow Puppets tem os dados mais espalhados.
...
As músicas mais famosas do Arctic Monkeys diferem bastante no quesito valência e um pouco menos em energia (variações maiores que 0.1), nas demais variáveis os valores são próximos (variações próximas de 0.1). A música mais diferente é a "Do I Wanna Know?" a menos energética e alegre (valência < 0.5) do grupo.
...
As faixas mais populares de The Last Shadow Puppets também se mostram diferentes, mas dessa vez em uma intensidade maior, as únicas categorias com valores próximos (variações menores que 0.1) são speechiness e instrumentalness. A música mais diferente é "Aviation", a mais energética do grupo.
